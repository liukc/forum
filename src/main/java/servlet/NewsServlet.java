...
public class NewsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(type.equals("add")){
            ...
            response.sendRedirect("/forum/jsp/news.jsp");

        }else if(type.equals("showANews")){
            Integer newsId=Integer.parseInt(request.getParameter("newsId"));
            News news=newsService.getNewsById(newsId);
            session.setAttribute("news", news);
            getServletContext().getRequestDispatcher("/forum/jsp/single.jsp").forward(request,response);
            ...
            getServletContext().getRequestDispatcher("/forum/jsp/manageNews.jsp").forward(request,response);
            ...
            getServletContext().getRequestDispatcher("/forum/news/newsShowByType.jsp").forward(request,response);
            return;
        }else if(type.equals("searchNews")){//通过关键字搜索新闻
            String newsName=request.getParameter("search");
            News news=newsService.getNewsByName(newsName);
            request.setAttribute("news", news);
