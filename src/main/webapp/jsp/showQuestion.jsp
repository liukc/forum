        ...
        <div class="row">
            ...
            <div class="span8 page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" title="View all posts in Server &amp; Database">${sessionScope.question.questionType}</a> <span class="divider">/</span></li>
                    <li class="active">${sessionScope.question.caption }</li>
                </ul>

                <article class=" type-post format-standard hentry clearfix">

                    <h1 class="post-title"><a href="#">${sessionScope.question.caption}</a></h1>

                    <div class="post-meta clearfix">
                        <span class="date">${sessionScope.question.questionTime }</span>
                        <span class="category"><a href="#" title="View all posts in Server &amp; Database">${sessionScope.question.questionType}</a></span>
                        <span class="comments"><a href="#" title="Comment on Integrating WordPress with Your Website">3 Comments</a></span>
                        <span class="like-count">66</span>
                    </div><!-- end of post meta -->

                    ${sessionScope.question.content}
                </article>
                ...
                <section id="comments">
                    ...
                    <ol class="commentlist">
                        ...
                        <li class="comment even thread-odd thread-alt depth-1" id="li-comment-4">
                            <article id="comment-4">
                                ...
                                <div class="comment-body">sdfasdf
                                </div><!-- end of comment-body -->
                    ...
                    <div id="respond">
                        ...
                        <form action="#" method="post" id="commentform">
                            ...
                            <div>
                                <input class="btn" name="submit" type="submit" id="submit"  value="发表评论">
                            </div>
            ...
            <aside class="span4 page-sidebar">
                ...
                <section class="widget"><h3 class="title">分类</h3>
                    <ul>
                        <li><a href="#" title="Lorem ipsum dolor sit amet,">生活</a> </li>
