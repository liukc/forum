	...
	$.fn.prettyPhoto = function(pp_settings) {
     ...
     <div class="pp_overlay"></div>',
		...
		;$.prettyPhoto.initialize = function() {
			...
			rel_index = (isSet) ? set_position : $("a[" + settings.hook + "^='" + theRel + "']").index($(this));_build_overlay(this);
		...
		function _build_overlay(caller) {
			...
			settings.markup = settings.markup.replace('{pp_social}', '');$('body').append(settings.markup);$pp_pic_holder = $('.pp_pic_holder'), $ppt = $('.ppt'), $pp_overlay = $('div.pp_overlay');
